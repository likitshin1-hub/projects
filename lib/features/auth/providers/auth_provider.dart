...
class AuthNotifier extends Notifier<AuthState> {
    ...
    try {
      ...
      if (result.status == LoginStatus.success) {
        ...
        if (apiResult.isSuccess) {
          state = AuthState(status: AuthStatus.success, user: userModel);
        } else {
          state = state.copyWith(
            status: AuthStatus.error,
  ...
  Future<void> loginWithLine() async {
    ...
    final result = await _repository.loginWithLine(accessToken: mockLineToken);
  ...
  Future<void> loginWithGoogle({UserModel? selectedUser}) async {
    ...
    if (selectedUser != null) {
      ...
      state = AuthState(status: AuthStatus.success, user: selectedUser);
