...
class AdminDataService extends ChangeNotifier {
  ...
  void _initData() {
    ...
    trackingDrivers = [
      // -------------------------------------------------------------
      // 🏙️ โซนกรุงเทพฯ & ปริมณฑล (Bangkok & Metro Fleet)
      // -------------------------------------------------------------
      DriverTrackingInfo(
        driverId: 'D001',
        ...
        currentRoad: 'ถ.สุขุมวิท 23 มุ่งหน้าแยกอโศกมนตรี กรุงเทพฯ',
      ...
      DriverTrackingInfo(
        ...
        status: TrackingStatus.inTransit,
        currentRoad: 'ถ.ลาดพร้าว ขาเข้ามุ่งหน้ารัชดาภิเษก กรุงเทพฯ',
      ...
      DriverTrackingInfo(
        ...
        currentRoad: 'ถ.พระราม 1 หน้าสยามพารากอน ปทุมวัน',
      ...
      DriverTrackingInfo(
        ...
        status: TrackingStatus.inTransit,
        currentRoad: 'ถ.วงแหวนอุตสาหกรรม สะพานภูมิพล 1 พระราม 3',
      ...
      // -------------------------------------------------------------
      // 🌊 โซนชลบุรี - พัทยา - ศรีราชา - บางแสน (Chonburi & Eastern Fleet)
      // -------------------------------------------------------------
      DriverTrackingInfo(
        driverId: 'D011',
        driverName: 'สมเกียรติ ชลบุรีเอ็กซ์เพรส',
        driverPhone: '089-777-6655',
        vehicleType: '🛵 มอเตอร์ไซค์',
        vehiclePlate: '1กข 7788 ชลบุรี',
        vehicleModel: 'Honda Wave 125i',
        vehicleColor: 'น้ำเงิน-ดำ',
        topRatio: 0.45,
        leftRatio: 0.55,
        lat: 13.3611,
        lng: 100.9847,
        ...
        signalStrength: '5G (ความแม่นยำ ±1.0ม.)',
        status: TrackingStatus.inTransit,
        currentRoad: 'ถ.สุขุมวิท ต.เสม็ด อ.เมืองชลบุรี จ.ชลบุรี (หน้าเซ็นทรัลพลาซา ชลบุรี)',
        activeOrderNo: 'TB668520',
        customerName: 'บจก. ชลบุรี ออโตเมชั่น',
        customerPhone: '038-112-233',
        pickupAddress: 'เซ็นทรัล ชลบุรี ถ.สุขุมวิท',
        dropoffAddress: 'ตลาดหนองมน บางแสน ชลบุรี',
        etaMinutes: 8,
        distanceRemainingKm: 3.4,
        todayEarnings: 750.0,
        todayCompletedJobs: 5,
        rating: 4.96,
        lastPing: DateTime.now().subtract(const Duration(seconds: 8)),
        waypoints: [
          TrackingWaypoint(title: 'รับเอกสารด่วน', address: 'เซ็นทรัล ชลบุรี', time: '14:35 น.', isCompleted: true),
          TrackingWaypoint(title: 'ผ่านแยกอ่างศิลา', address: 'ถ.สุขุมวิท ชลบุรี', time: '14:48 น.', isCurrent: true),
          TrackingWaypoint(title: 'ส่งมอบตลาดหนองมน', address: 'ตลาดหนองมน บางแสน', time: '15:05 น.'),
        ],
      ),
      DriverTrackingInfo(
        driverId: 'D012',
        driverName: 'ธวัชชัย ซิ่งพัทยา',
        driverPhone: '084-333-2211',
        vehicleType: '🚗 รถกระบะตู้ทึบ',
        vehiclePlate: '2ผพ 9988 ชลบุรี',
        vehicleModel: 'Isuzu D-Max 1.9 Ddi',
        ...
        currentRoad: 'ถ.พัทยาสาย 2 หาดจอมเทียน อ.บางละมุง จ.ชลบุรี',
      ...
      DriverTrackingInfo(
        driverId: 'D013',
        driverName: 'วิชาญ แหลมฉบังโลจิส',
        driverPhone: '086-112-9900',
        vehicleType: '🚛 รถบรรทุก 4 ล้อใหญ่',
        vehiclePlate: '3ฬฬ 1234 ชลบุรี',
        vehicleModel: 'Hino 300 Series',
        vehicleColor: 'ขาว',
        topRatio: 0.50,
        leftRatio: 0.50,
        lat: 13.1737,
        ...
        signalStrength: '5G (ความแม่นยำ ±2.0ม.)',
        status: TrackingStatus.inTransit,
        currentRoad: 'ถ.สุขุมวิท ท่าเรือแหลมฉบัง อ.ศรีราชา จ.ชลบุรี',
        activeOrderNo: 'TB668521',
        customerName: 'สยาม คอนเทนเนอร์ ศรีราชา',
        customerPhone: '038-490-500',
        pickupAddress: 'ท่าเรือแหลมฉบัง ประตู 2 ศรีราชา',
        dropoffAddress: 'นิคมอุตสาหกรรมปิ่นทอง 1 ศรีราชา',
        etaMinutes: 18,
        distanceRemainingKm: 8.5,
        todayEarnings: 2100.0,
        todayCompletedJobs: 2,
        rating: 4.88,
        lastPing: DateTime.now().subtract(const Duration(seconds: 22)),
        waypoints: [],
      ),
      DriverTrackingInfo(
        driverId: 'D014',
        driverName: 'นฤมล บางแสนสปีด',
        driverPhone: '085-888-4433',
        vehicleType: '🛵 มอเตอร์ไซค์',
        vehiclePlate: '1กง 5566 ชลบุรี',
        vehicleModel: 'Yamaha Fazzio 125',
        vehicleColor: 'เขียวมิ้นต์',
        topRatio: 0.40,
        leftRatio: 0.45,
        lat: 13.2833,
        lng: 100.9167,
        ...
        signalStrength: '5G (ความแม่นยำ ±1.0ม.)',
        status: TrackingStatus.available,
        currentRoad: 'วงเวียนหาดบางแสน ม.บูรพา ต.แสนสุข อ.เมืองชลบุรี',
        todayEarnings: 620.0,
        todayCompletedJobs: 4,
        rating: 4.97,
        lastPing: DateTime.now().subtract(const Duration(seconds: 10)),
        waypoints: [],
      ),
      DriverTrackingInfo(
        driverId: 'D015',
        driverName: 'กิตติชัย อมตะนคร',
        driverPhone: '082-555-6677',
        vehicleType: '🚗 รถกระบะตู้ทึบ',
        vehiclePlate: '1ฒณ 4321 ชลบุรี',
        vehicleModel: 'Toyota Revo 2.8',
        vehicleColor: 'เทาเข้ม',
        topRatio: 0.30,
        leftRatio: 0.60,
        lat: 13.4215,
        lng: 101.0310,
        ...
        status: TrackingStatus.sos,
        isSosAlert: true,
        sosReason: '🚨 รถสตาร์ทไม่ติด แบตเตอรี่หมด ที่นิคมอมตะซิตี้ ชลบุรี ซอย 8 ต้องการทีมช่างพ่วงแบตเตอรี่ด่วน',
        currentRoad: 'นิคมอุตสาหกรรมอมตะซิตี้ ชลบุรี ซอย 8 ต.ดอนหัวฬ่อ อ.เมืองชลบุรี',
        todayEarnings: 890.0,
        todayCompletedJobs: 3,
        rating: 4.82,
        lastPing: DateTime.now().subtract(const Duration(seconds: 4)),
        waypoints: [],
      ),
    ];
